            ...
            <x-filament::section icon="heroicon-o-pencil-square">
                ...
                <div class="space-y-4">
                    <x-filament::section compact class="transition-colors dark:group-hover:bg-gray-800 group-hover:bg-gray-50" collapsible collapsed>
                        <x-slot name="heading">
                            <div class="flex items-center justify-between gap-4">
                                <div @class([ 'grid rounded-full place-items-center size-8 text-sm font-semibold' , $this->registrant->registered_at
                                ...
                                <div class="px-2 py-2 transition-colors rounded-lg dark:group-hover:bg-gray-800 group-hover:bg-gray-50">
                                    <div class="flex items-center justify-between gap-4">
                                        <div @class([ 'grid rounded-full place-items-center size-8 text-sm font-semibold' , $section['value'] ? 'bg-success-500/20 text-success-700 dark:text-success-400' : 'bg-gray-100 dark:bg-gray-800' , ])>
                                            ...
                                            @else
                                            @if(isset($section['optional']) && $section['optional'] == true)
                                            <x-heroicon-o-check-circle class="text-gray-500 size-6" />
                                            @else
                                        ...
                                        <div class="grow">
                                            <div>
                                                ...
                                                @if(isset($section['optional']) && $section['optional'] == true)
                                                <small class="text-gray-500 dark:text-gray-400">Opsional</small>
                                                @endif
                                            </div>
                    ...
                    <x-filament::section compact class="transition-colors dark:group-hover:bg-gray-800 group-hover:bg-gray-50" collapsible collapsed>
                        ...
                        @else
                        <p>Belum ada pengumuman, pastikan Anda telah melakukan sesi wawancara dengan petugas PPDB</p>
                        @endif
                    </x-filament::section>
                    <x-filament::section compact class="transition-colors dark:group-hover:bg-gray-800 group-hover:bg-gray-50" collapsible collapsed>
                        ...
                        <x-slot name="heading">
                            <div class="flex items-center justify-between gap-4">
                                <div @class([ 'grid rounded-full place-items-center size-8 text-sm font-semibold' , $this->registrant->paid_off_at
                                    ? 'bg-success-500/20 text-success-700 dark:text-success-400'
                                    : ($paid
                        ...
                        @endif
                        @else
                        <div>Anda tidak memiliki tagihan karena belum dinyatakan diterima</div>
                        @endif
                    </x-filament::section>
                </div>
            </x-filament::section>
